...
const App = () => {
  ...
  const [events, setEvents] = useState([
    {"title": "Southeast CSCW @ Atlanta, Nov 2024", "date": "2024-11-01", "agenda": "https://sites.gatech.edu/hci-southeast/", "organizers": "Amy Chen, Azra Ismail, Grace Barkhuff, Haiqing Xu, Mohit Chandra, Shravika Mittal", participants: ["GA"], to_improve: "-"}, 
