...
const App = () => {
  ...
  const [events, setEvents] = useState([
    ...
    {"title": "Southeast gathering @ Atlanta, Nov 2023", "date": "2023-11-17", "agenda": "https://docs.google.com/document/d/1oos9HkOsB2xTvXtNrH_2OXjo5ks41lcTBFy1toBosxI/edit?usp=sharing", "organizers": "Soya Park, Chinmay Kulkarni and Richmond Wong", participants: ["GA", "NC"], to_improve: "-"}, 
